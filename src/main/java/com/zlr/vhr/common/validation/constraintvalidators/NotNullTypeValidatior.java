...
import com.zlr.vhr.common.validation.constraints.NotNullType;


/**
 * @NotNullValidator expand
 * @see org.hibernate.validator.internal.constraintvalidators.bv.NotNullValidator
 *
 * @author wangyd5
 */
public class NotNullTypeValidatior implements ConstraintValidator<NotNullType, Object> {
	...
	@Override
	public void initialize(NotNullType parameters) {

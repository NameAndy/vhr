...
import com.zlr.vhr.common.validation.constraints.NotBlankType;

/**
 * @NotBlankValidator expand
 * @see org.hibernate.validator.internal.constraintvalidators.hv.NotBlankValidator
 *
 * @author wangyd5
 */
public class NotBlankTypeValidatior implements ConstraintValidator<NotBlankType, Object> {
	...
	@Override
	public void initialize(NotBlankType parameters) {
